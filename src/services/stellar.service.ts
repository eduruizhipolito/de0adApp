...
import { CONTRACT_ADDRESS, HORIZON_NETWORK_PASSPHRASE, HORIZON_URL, SOROBAN_RPC_URL, STELLAR_FRIENDBOT_URL, STELLAR_NETWORK } from "../utils/constants";
...
getAsset(assetCode: string, assetIssuer: string): Asset {
  ...
  private createPaymentOperation(
    ...
    return Operation.payment({ //redeem
      amount,
      asset,
      destination,
    });
...
async payment(
    ...
    const asset = this.getAsset(
      assetCode,
      "GB6SH2CFQMKKI43Z5ZMRVCRGGIFR3W655HM7UST6Q7F33YI263WJYWW7"
    );
